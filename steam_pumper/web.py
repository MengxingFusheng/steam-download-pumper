...
def _source_list_section(topology_name: str) -> str:
  ...
  <section>
    ...
    <div class="metrics">
      ...
      <div class="metric">刷新状态<b id="sourceListRefreshState">idle</b></div>
      <div class="metric">应用状态<b id="sourceListApplyState">applied</b></div>
    ...
    def do_POST(self) -> None:
        ...
        try:
            if path == "/api/start":
                ...
                status = self.controller.request_source_list_refresh()
